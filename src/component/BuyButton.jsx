  ...
  const handleBuy = async () => {
    ...
    try {
      ...
      await buyNewAsset({ id, price })
        .then((result) => {
          console.log('Success', result), setAlert(' Asset Bought successfully');
        })
        .catch((error) => {
      ...
      >
        <div className="flex flex-col">
          ...
          <div className="flex flex-col justify-start rounded-xl mt-5">
            ...
            <p className="text-gray-500 text-xs my-1 ">Asset Description: {asset?.description}</p>
            <div className="flex justify-between items-center mt-3 text-gray-600">
              <div className="flex justify-start items-center">
                ...
                <div className="flex flex-col justify-center items-start">
                  ...
                  <small className=" text-xs text-pink-800">
