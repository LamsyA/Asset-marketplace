...
const AssetInstructions = () => {
  return (
    <div className='flex flex-auto justify-between items-center'>
      <div className="relative w-full bg-gray-800 font-poppins
        text-white
        flex flex-col justify-between items-center">
        <div className="flex flex-col py-4 md:py-8 px-4
          md:w-1/2">
          <div className="mx-auto bg-purple-900 rounded-md p-4 transition duration-300 ease-in-out  
            hover:scale-105">
        ...
        <div className="flex flex-col py-4 md:py-8 px-4
          ...
          <div className="mx-auto bg-purple-900 rounded-md p-4 transition duration-300 ease-in-out  
            ...
            <ul className="list-decimal pl-4 text-start items-center">
              ...
              <li className="mb-2">Click on the buy button to buy the asset.</li>
              <li className="mb-2">
                Click on the confirm asset button to confirm the purchase of the asset.
              </li>
              <li className="mb-2">
