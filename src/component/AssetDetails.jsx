      ...
      <div className="flex justify-center flex-col md:w-2/3">
        ...
        >
          ...
          <div className="flex-1 sm:py-0 py-4">
            ...
            <div className="flex justify-between items-center w-full pb-1">
              ...
              <div className="font-bold flex ">
                <div>
                  ...
                  <small className="flex text-yellow-700">
                    @owner {asset?.seller.slice(0, 4)}...{asset?.seller.slice(-5)}
                  </small>
                  {asset?.probe ? (
            ...
            <p className="text-sm font-light">Description {asset?.description}</p>
            <div className="w-full bg-gray-300 mt-4">
              <div
                className="bg-teal-600 text-ts font-medium p-0.5
                                leading-none rounded-l-full h-1 text-teal-100 text-center"
                style={{ width: `${asset?.status * 25}%` }}
              >
                {' '}
              </div>
            </div>
            <div className="flex justify-between items-center font-bold mt-2">
              ...
              <small className="flex justify-start items-center">
                ...
                <span>
                  {' '}
                  {asset?.seller.slice(0, 5)}...{asset?.seller.slice(-5)}
                </span>
              </small>
            </div>
            <div className="flex justify-start items-center my-5  space-x-6">
              {asset?.status == 0 ? (
                ...
                <button
                  className="inline-block bg-teal-500 px-5 py-2 text-white
                                font-medium text-xs leading-tight uppercase rounded-full 
              ...
              {connectedAccount == buyers?.owner && asset?.status == 1 ? (
                <div className="flex justify-start items-center my-5  space-x-6">
                  <button
                    className="inline-block bg-yellow-500 px-5 py-2 text-white
                                  font-medium text-xs leading-tight uppercase rounded-full 
              ...
              (asset?.status == 0 || asset?.status == 1 || asset?.status == 2) ? (
                <div className="flex justify-start items-center my-5  space-x-6">
                  <button
                    className="inline-block bg-yellow-500 px-5 py-2 text-white
                                  font-medium text-xs leading-tight uppercase rounded-full 
